...
from cogs.commands.tickets.start_ticket_system import OpenTicketDropDown, TicketControlButtons, OpenTicketOpenButton, LockedTicketButtons
...
class OnReady(commands.Cog):
    ...
    async def change_status(self):
        ...
        self.bot.add_view(OpenTicketOpenButton(self.bot))
        self.bot.add_view(TicketControlButtons(self.bot))
        self.bot.add_view(OpenTicketDropDown(self.bot))
        self.bot.add_view(LockedTicketButtons(self.bot))
